package uk.gov.hmcts.probate.services.notification.integration;
...
public class NotificationControllerTest {
    ...
    private static final String SERVICE_URL = "/notification/application-received";
    ...
    @Test
    public void sendApplicationReceived() throws Exception {
        ResultActions resultActions = mockMvc.perform(post(SERVICE_URL)
            .content(utils.getJSONFromFile("notification/success.json"))
